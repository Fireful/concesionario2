...
public class ClienteResourceIT {
    ...
    private static final Boolean DEFAULT_EMPRESA = false;
    private static final Boolean UPDATED_EMPRESA = true;
    ...
    public void createCliente() throws Exception {
        ...
        assertThat(testCliente.isEmpresa()).isEqualTo(DEFAULT_EMPRESA);
    }
    ...
    public void getAllClientes() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].empresa").value(hasItem(DEFAULT_EMPRESA.booleanValue())));
    }
    ...
    public void getCliente() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes/{id}", cliente.getId()))
            ...
            .andExpect(jsonPath("$.empresa").value(DEFAULT_EMPRESA.booleanValue()));
    }
    @Test
    @Transactional
    ...
    public void updateCliente() throws Exception {
        ...
        assertThat(testCliente.isEmpresa()).isEqualTo(UPDATED_EMPRESA);
    }
